...
import com.github.authorization.validator.groupvlidator.PageGroupValidator;
...
public class PageDTO implements Serializable {
     ...
     * 页码(开始页:1, 默认1，-1：所有)
     */
    @ApiModelProperty(value = "页码(开始页:1, 默认1，-1：所有)",required = true)
    ...
    @Min(value = 0,message = "开始时间必须大于0", groups = PageGroupValidator.class)
    ...
    @Min(value = 0,message = "结束时间必须大于0", groups = PageGroupValidator.class)
