package com.github.authorization.utils;
 ...
 * @author Rong.Jia
 * @date 2020/01/09 10:03
 */
@Slf4j
public class RestTemplateUtils {

    private static final RestTemplate restTemplate = (RestTemplate) SpringUtils.getBean("httpClientTemplate");
